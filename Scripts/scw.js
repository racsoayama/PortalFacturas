...
//******************************************************************************
    ...
    var scwTodayCellBorderColour = '#4F2170';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Week numbers */'                                        +
            'td.scwWeekNo               {background-color:  #4F2170;'   +
                                        'color:             #CCCCCC;}'  +
            '/* Enabled Days */'                                        +
            '/* Week Day */'                                            +
            ...
            'td.scwInputDate            {background-color:  #CE1126;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Weekend Day */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #fbfaf0;' +
                                        'color:             #4F2170;}'  +
            '/* Clear Button */'                                        +
            ...
            '/* Active cells */'                                        +
            'td.scwCells:hover,'                                        +
            'td.scwCellsHover           {background-color:  #4F2170;'   +
                                        'cursor:            pointer;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Day matching the input date */'                         +
            'td.scwInputDate:hover,'                                    +
            'td.scwInputDateHover       {background-color:  #4F2170;' +
                                        'cursor:            pointer;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Weekend cells */'                                       +
            'td.scwCellsWeekend:hover,'                                 +
            'td.scwCellsWeekendHover    {background-color:  #4F2170;' +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth:hover,'                                 +
            'td.scwCellsExMonthHover    {background-color:  #4F2170;' +
                                        'cursor:            pointer;'   +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwNow:hover,'                                          +
            'td.scwNowHover             {color:             #4F2170;' +
                                        'cursor:            pointer;'   +
                                        'font-weight:       bold;}'     +
            '/* Disabled cells */'                                      +
            '/* Week Day */'                                            +
            '/* Day matching the input date */'                         +
            'td.scwInputDateDisabled    {background-color:  #d0d0d0;' +
                                        'color:             #000000;}'  +
            'td.scwCellsDisabled        {background-color:  #d0d0d0;' +
                                        'color:             #000000;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekendDisabled {background-color:  #d0d0d0;' +
                                        'color:             #CC6666;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonthDisabled {background-color:  #d0d0d0;' +
                                        'color:             #666666;}'  +
            'td.scwNowDisabled          {background-color:  #f0f0f0;' +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
