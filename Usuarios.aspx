        ...
        <td valign="top">
            <div id="divDetalle" runat="server" style="display: block">
                <table frame="border" rules="none" bordercolor=#4c206c border="3" cellspacing="0">
                    <tr>
                        <td colspan="2"><asp:label ID="lblLeyUsuario" runat="server" CssClass="h3">Usuario</asp:label></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="lblTipoUsuario" runat="server" CssClass="label" Width="110">Tipo de usuario:</asp:Label></td>
                    ...
                    <tr>
                        <td><asp:Label ID="lblUsuario" runat="server" CssClass="label" Width="110">Usuario ID:</asp:Label></td>
                        <td><asp:TextBox ID="txtUsuario" runat="server" CssClass="text" MaxLength="10" Width="80" onKeyUp="changeToUpperCase(this.id);"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="lblNombre" runat="server" CssClass="label" Width="110">Nombre:</asp:Label></td>
                        <td><asp:TextBox ID="txtNombre" runat="server" CssClass="text" MaxLength="50" Width="300" ></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="lblProveedor" runat="server" CssClass="label" Width="110">Proveedor:</asp:Label></td>
                        <td><asp:TextBox ID="txtProveedor" runat="server" CssClass="text" MaxLength="10" Width="100" onKeyUp="validateNumeros(this.id);"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="lblCorreo" runat="server" CssClass="label" Width="110">Correo:</asp:Label></td>
                        <td><asp:TextBox ID="txtCorreo" runat="server" CssClass="text" MaxLength="40" Width="300"></asp:TextBox></td>
                    </tr>                    
                    <tr>
                        <td><asp:Label ID="lblPerfil" runat="server" CssClass="label" Width="110">Perfil:</asp:Label></td>
                        <td><asp:DropDownList ID="cboPerfiles" runat="server" CssClass="dropdownlist" Width ="200"></asp:DropDownList></td>
                    </tr>
                    <tr>
                        <td><asp:Label ID="lblStatus" runat="server" CssClass="label" Width="110">Estatus:</asp:Label></td>
                        <td><asp:DropDownList ID="cboStatus" runat="server" CssClass="dropdownlist" Width ="100"></asp:DropDownList></td>
                    </tr>
                    <tr>
