...
{
    public partial class BitProv : FormaPadre
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    dsDatos = oBitacora.Buscar("Proveedores.Importar", new DateTime(1900,1,1));
        ...
        protected void grdBitacora_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            try
            {
                ...
                NegocioPF.Bitacora oBitacora = new NegocioPF.Bitacora();
                dsDatos = oBitacora.Buscar("Proveedores.Importar", NegocioPF.Rutinas.ConvierteTextToFecha(txtFecha.Text));
                grdBitacora.DataSource = dsDatos;
                grdBitacora.DataBind();
            }
            catch (Exception ex)
        ...
        {
            lblTitulo.Text = oIdioma.Texto("BitProv");
