<%@ Page Title="" Language="C#" MasterPageFile="~/PortalFacturas.Master" AutoEventWireup="true" CodeBehind="BitFactLog.aspx.cs" Inherits="PortalFacturas.BitFactLog" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainPlaceHolder" runat="server">
       <table>
        <tr>
            <td>
                <asp:label ID="lblTitulo" runat="server" CssClass="h2">Consultar bitácora de facturas logísticas</asp:label>
            </td>
        </tr>
        <tr>
            <td>
