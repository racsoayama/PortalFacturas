<%@ Page Title="" Language="C#" MasterPageFile="~/PortalFacturas.Master" AutoEventWireup="true" CodeBehind="BitPeEnCi.aspx.cs" Inherits="PortalFacturas.BitPeEnCi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainPlaceHolder" runat="server">
     <table>
        <tr>
            <td>
                <asp:label ID="lblTitulo" runat="server" CssClass="h2">Consultar bitácora de interface de Pedidos</asp:label>
            </td>
        </tr>
        <tr>
            <td>
